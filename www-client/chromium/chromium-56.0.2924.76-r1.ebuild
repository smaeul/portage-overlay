...
IUSE="cups +dbus gnome gnome-keyring gtk3 +hangouts kerberos neon pic +proprietary-codecs pulseaudio selinux +suid +system-ffmpeg +tcmalloc widevine"
...
src_prepare() {
	local PATCHES=(
		...
		"${FILESDIR}/musl-mallinfo-r2.patch"
